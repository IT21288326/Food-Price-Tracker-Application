...
class CommentManagerAdapter (private val userCmtList:ArrayList<commentModel>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CommentManagerAdapter.ViewHolder {
        val itemView2 = LayoutInflater.from(parent.context).inflate(R.layout.shop_comment_list,parent,false)
    ...
    class ViewHolder(itemView2: View, clickListener: onItemClickListener) : RecyclerView.ViewHolder(itemView2){
